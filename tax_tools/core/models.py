...
class FilingFiling(models.Model):
    ...
    return_id = models.CharField(max_length=8)
    filing_type = models.CharField(max_length=5)
    ein = models.CharField(max_length=9)
    tax_period = models.IntegerField()
    sub_date = models.CharField(max_length=22)
    taxpayer_name = models.CharField(max_length=100)
    return_type = models.CharField(max_length=5)
    dln = models.CharField(max_length=14)
    object_id = models.CharField(max_length=18)
...
class ReturnSkedaPartV(models.Model):
    ...
    excssdstrbtncyvyr4amt = models.BigIntegerField(db_column='ExcssDstrbtnCyvYr4Amt', blank=True, null=True)  # Field name made lowercase.
    excssfrmyr5amt = models.BigIntegerField(db_column='ExcssFrmYr5Amt', blank=True, null=True)  # Field name made lowercase.
