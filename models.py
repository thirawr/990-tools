...
class MetadataDescription(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'metadata_description'


class MetadataGroup(models.Model):
    parent_sked = models.CharField(max_length=63, blank=True, null=True)
    parent_sked_part = models.CharField(max_length=63, blank=True, null=True)
    ordering = models.FloatField(blank=True, null=True)
    xpath = models.CharField(max_length=255, blank=True, null=True)
    db_name = models.CharField(max_length=63, blank=True, null=True)
    line_number = models.CharField(max_length=255, blank=True, null=True)
    description = models.TextField()
    headless = models.IntegerField(blank=True, null=True)
    versions = models.TextField()
...
class MetadataLinenumber(models.Model):
    xpath = models.CharField(max_length=255, blank=True, null=True)
    versions = models.TextField()
    line_number = models.CharField(max_length=255, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'metadata_linenumber'


class MetadataSchedulepart(models.Model):
    parent_sked = models.CharField(max_length=63, blank=True, null=True)
    parent_sked_part = models.CharField(max_length=63, blank=True, null=True)
    ordering = models.FloatField(blank=True, null=True)
    xpath = models.CharField(max_length=255, blank=True, null=True)
    part_name = models.CharField(max_length=255, blank=True, null=True)
    xml_root = models.CharField(max_length=255, blank=True, null=True)
    is_shell = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'metadata_schedulepart'


class MetadataVariable(models.Model):
    parent_sked = models.CharField(max_length=63, blank=True, null=True)
    parent_sked_part = models.CharField(max_length=63, blank=True, null=True)
    ordering = models.FloatField(blank=True, null=True)
    xpath = models.CharField(max_length=255, blank=True, null=True)
    in_a_group = models.IntegerField()
    db_table = models.CharField(max_length=63, blank=True, null=True)
    db_name = models.CharField(max_length=63, blank=True, null=True)
    irs_type = models.CharField(max_length=63, blank=True, null=True)
    db_type = models.CharField(max_length=63, blank=True, null=True)
    line_number = models.CharField(max_length=255, blank=True, null=True)
    description = models.TextField()
    versions = models.TextField()
    is_canonical = models.IntegerField(blank=True, null=True)
    canonical_version = models.CharField(max_length=16, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'metadata_variable'
